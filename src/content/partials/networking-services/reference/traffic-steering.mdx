...
Traffic destined for Internet routable addresses will be egressed to the Internet if it does not match a route in the virtual network. Any RFC-1918 or CGNAT (RFC6598) destined traffic that does not match a route within the virtual network will be dropped (null routed). 
